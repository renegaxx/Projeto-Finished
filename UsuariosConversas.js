...
const UsuariosConversas = () => {
    ...
    const renderUserItem = ({ item }) => {
        ...
        // Acessar o avatar a partir da constante avatarImages
        const avatar = avatarImages[item.avatar] || require('./assets/mcigPerfil.jpg'); // Se o avatar não for encontrado, usar a imagem padrão
